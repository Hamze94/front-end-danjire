...
const CartPage = () => {
    ...
    const handleCheckout = () => {
        ...
        console.log(order.user); // Include user data in the order
                    ...
                    {cartItems.length === 0 ? (
                        ...
                        <>
                            ...
                            {selectedUser && ( // Check if a user is selected
                                <p className="mt-3">Selected User: {users.find(user => user._id === selectedUser)?.name}</p>
                            )}
                            {cartItems.map(item => (
                            ...
                            <div className="mt-5">
                                ...
                                <button className='w-full bg-accent p-4 rounded-md text-white' onClick={handleCheckout}>Checkout</button>
                            </div>
                        </>
                    )}
                </div>
